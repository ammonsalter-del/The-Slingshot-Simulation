# Contributing to The Slingshot

Thank you for your interest in contributing to The Slingshot! This project is open source under CC BY-NC-SA 4.0, and we welcome contributions from educators, developers, and students.
...
- New sectors or industry variants
- Accessibility improvements
- Educational enhancements
- Localisation for different countries or languages
...
### Create Adaptations
Under the license, you're free to create your own versions of the game. If you create something interesting (a new sector, a translation, a variant for a different context), please let us know! We'd love to showcase community contributions.

### Improve Documentation
Help us improve the README, FAQ, Teaching Guide, or other documentation. Clear documentation helps everyone.

### Share Your Experience
Using the game in your teaching? We'd love to hear about it. Share your experiences, lesson plans, or student feedback in the Discussions section.
...
```
Add new Climate Tech sector events

- Added 15 new events specific to climate technology startups
- Includes regulatory changes, green funding opportunities, and carbon market dynamics
- Connects to existing milestone system
```
...
Thank you for helping make The Slingshot better!
