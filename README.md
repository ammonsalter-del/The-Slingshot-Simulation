...
**[▶ Play Now](https://ai-startup-game.github.io)** | **[Download](../../releases)** | **[Teaching Guide](docs/AI_Startup_Game_Teaching_Guide.pdf)**

![The AI Startup Game Screenshot](docs/screenshot.png)

## Overview

The AI Startup Game places students in the role of an AI startup founder making real strategic decisions under uncertainty. Set in the UK's thriving AI ecosystem in 2026, players experience what it takes to build a billion-dollar company in one of the world's most dynamic startup environments.
